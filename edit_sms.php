...
?> 
    ...
    <div class="content">
        ...
        <!-- BEGIN PlACE PAGE CONTENT HERE -->
         <form name="formmEdit" id="formEdit" method="POST" action="update_sms.php">
