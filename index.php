 <!-- begin header here-->
  <?php include 'partials/header.php' ?>
    <div id="body">
		<section id="content">
	    	<article>
				<h2>Introduction to MY Bulk SMS</h2>
				<p>
					mysms is a messaging service that allows users to send and receive SMS,
				 	MMS, and instant messages across different devices, including smartphones,
				  	tablets, and computers. It's known for offering an easy-to-use platform for
				   	text communication, particularly for users who want to manage all their 
				   	messages from one centralized location. 
				</p>		
			</article>
			<?php 
